package com.example.supetshop.Adapter;
...
public class CartListAdapter extends RecyclerView.Adapter<CartListAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull CartListAdapter.ViewHolder holder, int position) {
        ...
        holder.feeEachItem.setText(listItemSelected.get(position).getPrice() + " TL");
        holder.totalEachItem.setText(Math.round((listItemSelected.get(position).getNumberinCart()*listItemSelected.get(position).getPrice())) + " TL");
